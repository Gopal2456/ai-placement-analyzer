  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-6 text-gray-900 sm:px-6">
      <div className="mx-auto flex min-h-screen max-w-2xl items-center justify-center">
        <div className="w-full rounded-3xl bg-white px-6 py-6 shadow-xl shadow-gray-200/60 sm:px-10 sm:py-9">
          {/* Logo */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3 pt-1">
              <input
                ...
                type="checkbox"
                required
                className="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 accent-violet-600"
              />
              ...
              >
                ...
                <Link
                  href="/terms"
                  className="font-semibold text-gray-700 transition hover:text-violet-600"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
            ...
            <button
              type="submit"
              className="group flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-gray-950 text-sm font-semibold text-white shadow-lg shadow-gray-900/10 transition hover:bg-black"
            >
              Create account
